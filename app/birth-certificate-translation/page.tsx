      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-16 bg-white border-2 border-gray-200 rounded-lg p-8">
          <h2 className="text-3xl font-bold text-primary mb-6 text-center">
            We Translate All Birth Certificates
          </h2>
          <div className="grid md:grid-cols-2 gap-6">
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <span className="text-accent font-bold">→</span>
                <span><strong>Spanish:</strong> Mexico, Colombia, Argentina, Spain, Dominican Republic, etc.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-accent font-bold">→</span>
              ...
              <li className="flex items-start gap-3">
                <span className="text-accent font-bold">→</span>
                <span><strong>Arabic:</strong> Saudi Arabia, Iraq, Egypt, Lebanon, UAE formats</span>
              </li>
            </ul>
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-background p-6 rounded-lg">
              <p className="text-gray-700 mb-4 italic">
                "Maria needed her Mexican birth certificate translated for her marriage-based visa. Delivered in 24 hours and accepted by USCIS first try."
              </p>
              <p className="text-sm text-gray-600">— Marriage-based green card</p>
            </div>
            <div className="bg-background p-6 rounded-lg">
              <p className="text-gray-700 mb-4 italic">
                "Chen submitted his translation for naturalization (N-400) and it was accepted without any issues or RFEs."
              </p>
              <p className="text-sm text-gray-600">— Citizenship application</p>
            </div>
            <div className="bg-background p-6 rounded-lg">
              <p className="text-gray-700 mb-4 italic">
                "Ahmed needed his birth certificate for university enrollment. The certified translation was exactly what they required."
              </p>
