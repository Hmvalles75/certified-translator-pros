...
export default function WhyChooseUs() {
  const features = [
    ...
    },
    {
      ...
      description: "Official certified translations accepted by USCIS, IRCC, courts, universities, and government agencies. If it's rejected, we'll redo it free.",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "$29 per page for certified translations, $0.12 per word for standard. See your exact price instantly before you pay. No hidden fees ever.",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
