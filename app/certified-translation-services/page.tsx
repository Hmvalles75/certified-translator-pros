        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button href="/order/certified" variant="primary">
              Start Your Order (Takes 2 Minutes)
            </Button>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span><strong>Civil documents:</strong> Birth, marriage, divorce, death certificates</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-accent font-bold">→</span>
                <span><strong>Academic:</strong> Diplomas, transcripts, degrees, certificates</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-accent font-bold">→</span>
                <span><strong>Legal:</strong> Contracts, court documents, powers of attorney</span>
              </li>
            </ul>
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <span className="text-accent font-bold">→</span>
                <span><strong>Business:</strong> Financial statements, corporate documents</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-accent font-bold">→</span>
                <span><strong>Medical:</strong> Health records, vaccination records, prescriptions</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-accent font-bold">→</span>
                <span><strong>All languages:</strong> 100+ language pairs supported</span>
              </li>
            </ul>
          </div>
        </section>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-background p-6 rounded-lg">
              <p className="text-gray-700 mb-4 italic">
                "Translated multiple documents for immigration. Every single one was accepted by USCIS. Professional quality, fair pricing."
              </p>
              <p className="text-sm text-gray-600">— Immigration applicant</p>
            </div>
            <div className="bg-background p-6 rounded-lg">
              <p className="text-gray-700 mb-4 italic">
                "Needed my foreign diploma translated for state board licensing. Fast turnaround, accepted without any issues."
              </p>
              <p className="text-sm text-gray-600">— Professional licensing</p>
            </div>
            <div className="bg-background p-6 rounded-lg">
              <p className="text-gray-700 mb-4 italic">
                "Court required certified translations of legal documents. Everything was perfect, judge accepted all translations."
              </p>
              <p className="text-sm text-gray-600">— Court proceedings</p>
            </div>
          </div>
        </section>
