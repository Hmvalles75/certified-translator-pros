          ...
          <div className="grid md:grid-cols-2 gap-6">
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span><strong>Spanish:</strong> Most common request, all regions covered</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-accent font-bold">→</span>
                <span><strong>Chinese:</strong> Mandarin, Cantonese, all Chinese dialects</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-accent font-bold">→</span>
                <span><strong>Arabic:</strong> All Middle Eastern countries and dialects</span>
              </li>
            </ul>
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <span className="text-accent font-bold">→</span>
                <span><strong>European:</strong> French, German, Italian, Polish, Russian, Portuguese</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-accent font-bold">→</span>
                <span><strong>Asian:</strong> Hindi, Korean, Japanese, Vietnamese, Tagalog, Thai</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-accent font-bold">→</span>
                <span><strong>100+ languages</strong> from every country worldwide</span>
              </li>
            </ul>
          </div>
        </section>
